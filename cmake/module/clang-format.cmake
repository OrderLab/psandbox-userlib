set(CLANG_FORMAT_FILE_EXTENSIONS ${CLANG_FORMAT_FILE_EXTENSIONS} *.cpp *.h *.hpp *.cc *.c)
...
if(CLANG_FORMAT_EXE)
  ...
  add_custom_target(
    ...
    WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
    COMMAND ${CMAKE_CURRENT_LIST_DIR}/../script/clang-format-changed.py --check-only --clang-format-bin ${CLANG_FORMAT_EXE} ${SOURCE_FILES_TO_FORMAT}
  )
  add_custom_target(
    format-all
    COMMENT "Formatting all source files"
    COMMAND ${CLANG_FORMAT_EXE} -i -style=file ${SOURCE_FILES_TO_FORMAT}
  )
endif()
